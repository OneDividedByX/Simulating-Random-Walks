...
v_0=np.array([0.1,0.3,0.5,0.1])
v_1=np.array([0,0.5,0.5,0])
v_2=np.array([0.5,0.2,0.2,0.1])
v_3=np.array([0.5,0,0,0.5])
...
# simulate_markov_chain(P, X_0, speed=10, n_steps=None)

# graph_simulate_markov_chain(P,X_0,5,'discrete',n_steps=None)
